...
import {NAVIGATION_TINT_COLOR, WHITE_BACKGROUND_COLOR} from '../../constants'
...
class NavigationButton extends Component {
  ...
  render() {
    ...
    const renderIcon = () => <Icon color = {NAVIGATION_TINT_COLOR} size = {40} name = {icon}/>

        ...
        >
          <View style={styles.controlContainer}>
            ...
            <View style={styles.sendControlContainer}>
              <ChatButton icon="ios-attach" onPress={this.attachHandler} isActive={this.tempAttachments.length < 10} />
              ...
              <ChatButton
                ...
                isActive={
                  this.message /*|| this.tempAttachments.length && this.tempAttachments.every(file => file.loaded)*/
                }
              />
            </View>
          </View>
